...
@Component
class QuotaRebalanceRunner {

    private static final Logger log = LoggerFactory.getLogger(QuotaRebalanceRunner.class);
    ...
    QuotaRebalanceRunner(QuotaRepository quotaRepository,
    ...
    public Map<String, String> execute(Instant now) {
        ...
        return Map.of("rebalanced", String.valueOf(rebalanced), "skipped", String.valueOf(skipped));
    }
}
