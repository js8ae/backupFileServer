...
@Component
class RetentionPolicyRunner {

    private static final Logger log = LoggerFactory.getLogger(RetentionPolicyRunner.class);
    ...
    RetentionPolicyRunner(ArtifactRepository artifactRepository,
    ...
    public Map<String, String> execute(Instant now) {
        ...
        if (expired.isEmpty()) {
            return Map.of("moved", "0", "failed", "0");
        }
        ...
        return Map.of("moved", String.valueOf(moved), "failed", String.valueOf(failed));
    }
}
