...
public class ExpiredSessionCleanupJob {
    ...
    private static final String JOB_NAME = "ExpiredSessionCleanupJob";

    private final ExpiredSessionCleanupRunner runner;
    private final JobExecutionLogPort jobExecutionLogPort;

    public ExpiredSessionCleanupJob(ExpiredSessionCleanupRunner runner,
